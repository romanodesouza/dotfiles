...
values."
  ...
  (setq-default
   ...
   dotspacemacs-enable-paste-transient-state y
...
(defun my/toggle-last-two-buffers ()
  (interactive)
...
(defun my/key-bindings ()
  ...
  (key-chord-define-global ",d" 'counsel-imenu)
  (key-chord-define-global ",g" 'my/toggle-last-two-buffers)
