...
`dotspacemacs/user-config' first."
  ...
  (add-to-list 'load-path (expand-file-name "private/local" user-emacs-directory)))
...
(defun save-buffers-and-goes-to-normal-mode ()
  (interactive)
  (save-some-buffers 'no-confirm)
  (message "buffers has been saved")
  (evil-normal-state))

(defun toggle-last-two-buffers ()
  (interactive)
...
(defun my/key-bindings ()
  ;; key chord
  (key-chord-define-global ",q" 'delete-window-maybe-kill-buffer)
  (key-chord-define-global ",w" 'delete-other-windows)
  (key-chord-define-global ",e" 'end-of-line)
  (key-chord-define-global ",a" 'my/git-grep)
  (key-chord-define-global ",s" 'save-buffers-and-goes-to-normal-mode)
  (key-chord-define-global ",d" 'helm-semantic-or-imenu)
  (key-chord-define-global ",g" 'toggle-last-two-buffers)
  ...
  (define-key evil-motion-state-map (kbd "C-h") 'spacemacs/previous-useful-buffer)
  (define-key evil-motion-state-map (kbd "C-l") 'spacemacs/next-useful-buffer)
  (evil-define-key 'insert yas-minor-mode-map (kbd "<tab>") 'my/company-tab)

  (spacemacs/set-leader-keys
    "pf" 'projectile-or-ido
    "fp" 'projectile-or-ido
